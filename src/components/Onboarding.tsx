...
const SLIDES = [{"accent": "#ec4899", "icon": "\ud83d\udd12", "title": "Hide photos\nprivately", "desc": "Move sensitive photos into an encrypted vault. They disappear from your main gallery \u2014 only you can see them."}, {"accent": "#ec4899", "icon": "\ud83d\udcc1", "title": "Create private\nalbums", "desc": "Organize hidden photos into albums. Birthday surprises, private memories, business documents \u2014 all secure."}, {"accent": "#ec4899", "icon": "\ud83d\udee1\ufe0f", "title": "PIN protected.\nAES-256 encrypted.", "desc": "A PIN lock plus military-grade encryption. Even if someone has your device, your photos stay private."}];
export function Onboarding({ onDone }: { onDone: () => void }) {
  const [idx, setIdx] = useState(0);
  const slide = SLIDES[idx];
  return (
    <div style={{ minHeight:'100vh', display:'flex', flexDirection:'column', background:'#080808', overflow:'hidden', position:'relative' }}>
      ...
      <div style={{ padding:'20px 24px', display:'flex', justifyContent:'flex-end' }}>
        <button onClick={onDone} style={{ color:'#ec489960', fontSize:'14px', background:'none', border:'none', cursor:'pointer', fontFamily:'Inter, sans-serif' }}>Skip</button>
      </div>
